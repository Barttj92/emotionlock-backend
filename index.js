...
// =====================
// Scout Agents (Reddit + X) — removed 2026-08-21.
// These polled Reddit every 30 min and X every 15 min, and did an unindexed
// `select ... where url = ?` against the ever-growing `opportunities` table
// for every matching post before inserting. opportunities.url was never
// indexed, so this was a full table scan per match, run forever, and was
// identified as the dominant driver of the Supabase Disk IO Budget
// exhaustion on 2026-08-20/21. Removed entirely rather than just indexed,
// per Bart's call to drop Reddit/X scouting altogether.
// =====================
